 ...
 */
public class SwipyAdapter extends BaseAdapter {
    private MyApp myApp;
//    private RequestQueue mRequestQueue;
    private ImageLoader imageLoader;
    protected LayoutInflater mInflater;
    private List<String> dataList;
    public SwipyAdapter(Context context, List<String> dataList) {
...
//        imageLoader = new ImageLoader(mRequestQueue, new BitmapCache(myApp));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(viewHolder == null) {
            ...
            convertView = mInflater.inflate(R.layout.swipy_item, parent, false);
